...
{
    public class ViewStoreContents:IEncapsulateUserFunctionality
    {
        IProvideInformationAboutTheStore store_directory;
        IDisplayInformation report_engine;

        public ViewStoreContents():this(Stub.with<StubStoreDirectory>(),
        Stub.with<StubReportEngine>())
        {
        }

        public ViewStoreContents(IProvideInformationAboutTheStore store_directory, IDisplayInformation report_engine)
        {
